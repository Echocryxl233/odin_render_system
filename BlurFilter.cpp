...
//  DXGI_FORMAT format) : mWidth(width), mHeight(height), mFormat(format)
//{
//  md3dDevice = device;
//  BuildResources();
//}
...
//
//  md3dDevice->CreateShaderResourceView(mBlurMap0.Get(), &srv_desc, mBlur0CpuSrv);
//	md3dDevice->CreateUnorderedAccessView(mBlurMap0.Get(), nullptr, &uav_desc, mBlur0CpuUav);
//  
//  md3dDevice->CreateShaderResourceView(mBlurMap1.Get(), &srv_desc, mBlur1CpuSrv);
//	md3dDevice->CreateUnorderedAccessView(mBlurMap1.Get(), nullptr, &uav_desc, mBlur1CpuUav);
//}
//
