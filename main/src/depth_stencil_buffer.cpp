...
void DepthStencilBuffer::Create(ID3D12Device* device, uint32_t width, uint32_t height, DXGI_FORMAT format) {
  ...
  CreateTextureResource(device, L"Depth Stencil", resource_desc, clear_value);
